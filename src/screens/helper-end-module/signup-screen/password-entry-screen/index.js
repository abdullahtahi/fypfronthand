...
const HelperPasswordEntryScreen = ({ navigation, route }) => {
    ...
    const onSetPassword = () => {
        if (isPasswordValid && isConfirmPasswordValid) {
            navigation.dispatch(
                StackActions.replace('Helper Data Entry Screen', {
            ...
            <ImageBackground style={styles.backgroundImage} source={require('../../../../assets/images/images2.jpg')} >
                <ScrollView>
                    ...
                    <Text style={{fontSize: 23, color: '#000', fontWeight: 'bold', textAlign: 'center', marginTop: '60%'}}>Local On Work</Text>
                        ...
                        <View>
                            <Text style={styles.screenHeader}>Enter Password</Text>
                        </View>
...
export default HelperPasswordEntryScreen