...
const MapViewCompMechanic = (props) => {
    ...
    const getHelpersFromDb = () => {
        axios.get('https://fyp-ustaad-app.herokuapp.com/get-towers-for-mechanic')
            .then(response => {
        ...
        Alert.alert(
            ...
            [
                ...
                },
                {
                    text: "Send Request",
                    onPress: () => {
                        axios.post('https://fyp-ustaad-app.herokuapp.com/mechanic-request-to-tower-for-service', {
                            sender: {
                                ...props.user,
                                lastLocation: {
